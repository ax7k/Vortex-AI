import { grok, createAgent, createTool, createNetwork } from "@inngest/agent-kit";
    ...
    const codeAgent = createAgent({
      ...
      tools: [
        ...
        createTool({
          ...
          description: "Creates or updates a file in the code sandbox",
          parameters: z.object({
            files: z.array(
              z.object({
                path: z.string(),
        ...
        createTool({
          name: "readFile",
          description: "Reads files from the code sandbox",
          parameters: z.object({
